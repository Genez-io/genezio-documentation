...
2. Navigate to the folder `cd ./genezio-examples/typescript/getting-started`
...
Github files are available [**here**](https://github.com/Genez-io/genezio-examples/tree/master/typescript/getting-started).
