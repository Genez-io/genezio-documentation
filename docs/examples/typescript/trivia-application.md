...
:::info
The source code for this example is public on the following [GitHub repository.](https://github.com/Genez-io/genezio-examples/tree/master/typescript/quiz-app-prisma)
:::
...
Deploy your project using the genezio deploy command from the `./genezio-examples/typescript/quiz-app-prisma` directory.
